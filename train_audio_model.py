'''
BU DOSYAYI ÇALIŞTIRMADAN main.py DOSYASINI ÇALIŞTIRMAYINIZ. AKSİ TAKDİRDE SES DEĞERLENDİRME MEKANİZMASI ÇALIŞMAYACAKTIR.
DETAYLAR İÇİN README.md DOSYASINI REFERANS ALINIZ.
'''
